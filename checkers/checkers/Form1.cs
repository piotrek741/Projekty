...
namespace Checkers
{
    public partial class Form1 : Form
    {
        ...
        public object P1NameLabel { get; private set; }
        public object P2NameLabel { get; private set; }
            ...
            try
            {
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        ...
                        {
                            buttons[i, j].GetButton.Image = Properties.Resources.red;
                        }
                ...
                for (int i = 0; i < 8; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        if (currentbtn.Image == buttons[i, j].GetButton.Image)
                        {
                            ...
                            {
                                if (buttons[i, j].GetButton.Image == Properties.Resources.red)
                                {
                                    selectedbutton = buttons[i, j];
                                }
                            }
